/* eslint-disable react/prop-types */
 import {   Line,  Bar, Rectangle, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, ComposedChart } from 'recharts';
  
export default function ChartEnrConTre(){
  const data = [
